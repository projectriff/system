...
func AdapterReconciler(c reconcilers.Config) *reconcilers.ParentReconciler {
...
func AdapterBuildRefReconciler(c reconcilers.Config) reconcilers.SubReconciler {
...
func AdapterTargetRefReconciler(c reconcilers.Config) reconcilers.SubReconciler {
