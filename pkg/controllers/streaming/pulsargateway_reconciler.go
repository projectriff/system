...
func PulsarGatewayReconciler(c reconcilers.Config, namespace string) *reconcilers.ParentReconciler {
...
func PulsarGatewaySyncConfigReconciler(c reconcilers.Config, namespace string) reconcilers.SubReconciler {
...
func PulsarGatewayChildGatewayReconciler(c reconcilers.Config) reconcilers.SubReconciler {
	...
	return &reconcilers.ChildReconciler{
		...
		DesiredChild: func(ctx context.Context, parent *streamingv1alpha1.PulsarGateway) (*streamingv1alpha1.Gateway, error) {
