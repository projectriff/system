...
func KafkaGatewayReconciler(c reconcilers.Config, namespace string) *reconcilers.ParentReconciler {
...
func KafkaGatewaySyncConfigReconciler(c reconcilers.Config, namespace string) reconcilers.SubReconciler {
...
func KafkaGatewayChildGatewayReconciler(c reconcilers.Config) reconcilers.SubReconciler {
