...
func InMemoryGatewayReconciler(c reconcilers.Config, namespace string) *reconcilers.ParentReconciler {
...
func InMemoryGatewayChildGatewayReconciler(c reconcilers.Config) reconcilers.SubReconciler {
