...
func GatewayReconciler(c reconcilers.Config) *reconcilers.ParentReconciler {
...
func GatewayChildServiceReconciler(c reconcilers.Config) reconcilers.SubReconciler {
...
func GatewayChildDeploymentReconciler(c reconcilers.Config) reconcilers.SubReconciler {
