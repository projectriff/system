...
import (
	...
	"github.com/projectriff/system/pkg/reconciler/v1alpha1/knativehandler/resources"
	resourcenames "github.com/projectriff/system/pkg/reconciler/v1alpha1/knativehandler/resources/names"
	"go.uber.org/zap"
...
type Reconciler struct {
	*reconciler.Base
	...
	handlerLister         knativelisters.HandlerLister
...
func NewController(
	...
	handlerInformer knativeinformers.HandlerInformer,
	...
	knconfigurationInformer.Informer().AddEventHandler(cache.FilteringResourceEventHandler{
		FilterFunc: controller.Filter(knativev1alpha1.SchemeGroupVersion.WithKind("Handler")),
...
func (c *Reconciler) reconcile(ctx context.Context, handler *knativev1alpha1.Handler) error {
	logger := logging.FromContext(ctx)
...
func (c *Reconciler) updateStatus(desired *knativev1alpha1.Handler) (*knativev1alpha1.Handler, error) {
	...
	h, err := c.ProjectriffClientSet.KnativeV1alpha1().Handlers(desired.Namespace).UpdateStatus(existing)
...
func (c *Reconciler) reconcileBuild(handler *knativev1alpha1.Handler) error {
...
func (c *Reconciler) reconcileConfiguration(ctx context.Context, handler *knativev1alpha1.Handler, configuration *knservingv1alpha1.Configuration) (*knservingv1alpha1.Configuration, error) {
	logger := logging.FromContext(ctx)
...
func (c *Reconciler) createConfiguration(handler *knativev1alpha1.Handler) (*knservingv1alpha1.Configuration, error) {
...
func (c *Reconciler) reconcileRoute(ctx context.Context, handler *knativev1alpha1.Handler, route *knservingv1alpha1.Route) (*knservingv1alpha1.Route, error) {
	logger := logging.FromContext(ctx)
...
func (c *Reconciler) createRoute(handler *knativev1alpha1.Handler) (*knservingv1alpha1.Route, error) {
