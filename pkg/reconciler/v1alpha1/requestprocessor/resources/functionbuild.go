...
// MakeFunctionBuild creates a FunctionBuild from an RequestProcessor object.
func MakeFunctionBuild(rp *runv1alpha1.RequestProcessor, i int) (*buildv1alpha1.FunctionBuild, error) {
