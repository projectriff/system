...
func makeLabels(a *projectriffv1alpha1.Application) map[string]string {
	labels := make(map[string]string, len(a.ObjectMeta.Labels)+1)
	labels[projectriff.ApplicationLabelKey] = a.Name
