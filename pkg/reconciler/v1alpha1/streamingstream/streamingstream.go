...
import (
	...
	streaminginformers "github.com/projectriff/system/pkg/client/informers/externalversions/streaming/v1alpha1"
	streamlisters "github.com/projectriff/system/pkg/client/listers/streaming/v1alpha1"
...
func NewController(
	...
	streamingInformer streaminginformers.StreamInformer,
) *controller.Impl {
	...
	streamingInformer.Informer().AddEventHandler(cache.ResourceEventHandlerFuncs{
...
func (c *Reconciler) reconcile(ctx context.Context, stream *streamingv1alpha1.Stream) error {
	logger := logging.FromContext(ctx)
...
func (c *Reconciler) updateStatus(desired *streamingv1alpha1.Stream) (*streamingv1alpha1.Stream, error) {
	...
	s, err := c.ProjectriffClientSet.StreamingV1alpha1().Streams(desired.Namespace).UpdateStatus(existing)
...
func createStream(provider string, stream string) (*streamingv1alpha1.StreamAddress, error) {
