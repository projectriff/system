...
var handlersResource = schema.GroupVersionResource{Group: "knative.projectriff.io", Version: "v1alpha1", Resource: "handlers"}

var handlersKind = schema.GroupVersionKind{Group: "knative.projectriff.io", Version: "v1alpha1", Kind: "Handler"}
