...
import (
	v1alpha1 "github.com/projectriff/system/pkg/client/clientset/versioned/typed/projectriff/v1alpha1"
...
func (c *FakeProjectriffV1alpha1) Applications(namespace string) v1alpha1.ApplicationInterface {
