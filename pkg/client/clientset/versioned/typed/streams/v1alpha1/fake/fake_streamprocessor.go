...
var streamprocessorsResource = schema.GroupVersionResource{Group: "streams.projectriff.io", Version: "v1alpha1", Resource: "streamprocessors"}

var streamprocessorsKind = schema.GroupVersionKind{Group: "streams.projectriff.io", Version: "v1alpha1", Kind: "StreamProcessor"}
...
func (c *FakeStreamProcessors) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.StreamProcessor, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(streamprocessorsResource, c.ns, name, data, subresources...), &v1alpha1.StreamProcessor{})
