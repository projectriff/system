...
import (
	v1alpha1 "github.com/projectriff/system/pkg/client/clientset/versioned/typed/streams/v1alpha1"
	rest "k8s.io/client-go/rest"
	testing "k8s.io/client-go/testing"
)

type FakeStreamsV1alpha1 struct {
	*testing.Fake
}
...
func (c *FakeStreamsV1alpha1) RESTClient() rest.Interface {
