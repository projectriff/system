...
var processorsResource = schema.GroupVersionResource{Group: "streams.projectriff.io", Version: "v1alpha1", Resource: "processors"}

var processorsKind = schema.GroupVersionKind{Group: "streams.projectriff.io", Version: "v1alpha1", Kind: "Processor"}
