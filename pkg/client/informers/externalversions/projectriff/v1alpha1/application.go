...
import (
	...
	v1alpha1 "github.com/projectriff/system/pkg/client/listers/projectriff/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.ProjectriffV1alpha1().Applications(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ProjectriffV1alpha1().Applications(namespace).Watch(options)
			},
		},
		&projectriff_v1alpha1.Application{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *applicationInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&projectriff_v1alpha1.Application{}, f.defaultInformer)
}
